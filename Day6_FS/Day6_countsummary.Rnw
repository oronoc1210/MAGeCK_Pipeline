...
library(xtable)
filelist=c("PO1f_1_d6.fastq","PO1f_2_d6.fastq","PO1f_3_d6.fastq","PO1f_Cas9_1_d6.fastq","PO1f_Cas9_2_d6.fastq","PO1f_Cas9_3_d6.fastq");
labellist=c("PO1f_1","PO1f_2","PO1f_3","PO1f_Cas9_1","PO1f_Cas9_2","PO1f_Cas9_3");
reads=c(16616764,10471638,15579062,21402912,1818357,9563799);
mappedreads=c(13536990,7829815,9828003,9458118,1212438,6641688);
totalsgrnas=c(47591,47591,47591,47591,47591,47591);
zerocounts=c(1393,1408,1270,6040,9084,5922);
giniindex=c(0.14387847306110468,0.15227037108096098,0.14501232074142156,0.3561946241249738,0.3982807139692688,0.30519142639208496);
...
genboxplot("Day6.count_normalized.txt");
@
...
genhistplot("Day6.count_normalized.txt");
@
...
genpcaplot("Day6.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.3,height=5.3>>=
genclustering("Day6.count_normalized.txt");
@
