...
library(xtable)
filelist=c("PO1f_1_d4.fastq","PO1f_2_d4.fastq","PO1f_3_d4.fastq","PO1f_Cas9_ku70_1_d4.fastq","PO1f_Cas9_ku70_2_d4.fastq","PO1f_Cas9_ku70_3_d4.fastq");
labellist=c("PO1f_1","PO1f_2","PO1f_3","PO1f_Cas9_ku70_1","PO1f_Cas9_ku70_2","PO1f_Cas9_ku70_3");
reads=c(12587220,16277931,24367796,5628412,9273365,7716327);
mappedreads=c(10987498,13794560,21378876,3676281,6069100,4903829);
totalsgrnas=c(47591,47591,47591,47591,47591,47591);
zerocounts=c(1198,1062,1133,23072,24189,19251);
giniindex=c(0.13340003480285345,0.12262755312268725,0.11476407813330314,0.6776618702098924,0.6599940016292931,0.6147093777113813);
...
<<fig=TRUE,echo=FALSE,width=5.3,height=4.5>>=
genboxplot("Day4_CS.count_normalized.txt");
@

The following figure shows the histogram of median-normalized read counts in all samples.


<<fig=TRUE,echo=FALSE,width=5.3,height=5.3>>=
genhistplot("Day4_CS.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=7.3,height=5.3>>=
genpcaplot("Day4_CS.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.3,height=5.3>>=
genclustering("Day4_CS.count_normalized.txt");
@
