...
library(xtable)
filelist=c("PO1f_1_d2.fastq","PO1f_2_d2.fastq","PO1f_3_d2.fastq","PO1f_Cas9_ku70_1_d2.fastq","PO1f_Cas9_ku70_2_d2.fastq","PO1f_Cas9_ku70_3_d2.fastq");
labellist=c("PO1f_1","PO1f_2","PO1f_3","PO1f_Cas9_ku70_1","PO1f_Cas9_ku70_2","PO1f_Cas9_ku70_3");
reads=c(13963047,18252805,13921466,12829964,3189109,12489764);
mappedreads=c(11738725,15914205,12167132,11182238,2726663,10569636);
totalsgrnas=c(47591,47591,47591,47591,47591,47591);
zerocounts=c(336,332,336,332,437,342);
giniindex=c(0.09183189145833615,0.0872513372835465,0.0901353483994557,0.09184384565060433,0.122905539836616,0.09361477221297221);
...
genboxplot("Day2_CS.count_normalized.txt");
@
...
genhistplot("Day2_CS.count_normalized.txt");
@
...
genpcaplot("Day2_CS.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.3,height=5.3>>=
genclustering("Day2_CS.count_normalized.txt");
@
