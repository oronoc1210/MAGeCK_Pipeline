...
library(xtable)
filelist=c("PO1f_1_d4.fastq","PO1f_2_d4.fastq","PO1f_3_d4.fastq","PO1f_Cas9_1_d4.fastq","PO1f_Cas9_2_d4.fastq","PO1f_Cas9_3_d4.fastq");
labellist=c("PO1f_1","PO1f_2","PO1f_3","PO1f_Cas9_1","PO1f_Cas9_2","PO1f_Cas9_3");
reads=c(12587220,16277931,24367796,15207158,2784664,6819652);
mappedreads=c(10987498,13794560,21378876,11637395,1516258,4735158);
totalsgrnas=c(47591,47591,47591,47591,47591,47591);
zerocounts=c(1198,1062,1133,4434,6983,4431);
giniindex=c(0.13340003480285345,0.12262755312268725,0.11476407813330314,0.25918957952164745,0.3669941709053386,0.27739491156322293);
...
genboxplot("Day4.count_normalized.txt");
@
...
genhistplot("Day4.count_normalized.txt");
@
...
genpcaplot("Day4.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.3,height=5.3>>=
genclustering("Day4.count_normalized.txt");
@
