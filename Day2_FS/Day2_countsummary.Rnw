...
library(xtable)
filelist=c("PO1f_1_d2.fastq","PO1f_2_d2.fastq","PO1f_3_d2.fastq","PO1f_Cas9_1_d2.fastq","PO1f_Cas9_2_d2.fastq","PO1f_Cas9_3_d2.fastq");
labellist=c("PO1f_1","PO1f_2","PO1f_3","PO1f_Cas9_1","PO1f_Cas9_2","PO1f_Cas9_3");
reads=c(13963047,18252805,13921466,12545545,4247940,1154873);
mappedreads=c(11738725,15914205,12167132,10651973,3529352,968962);
totalsgrnas=c(47591,47591,47591,47591,47591,47591);
zerocounts=c(336,332,336,338,434,947);
giniindex=c(0.09183189145833615,0.0872513372835465,0.0901353483994557,0.09736251347345048,0.12151714283824433,0.16982062434224987);
...
genboxplot("Day2.count_normalized.txt");
@
...
genhistplot("Day2.count_normalized.txt");
@
...
genpcaplot("Day2.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.3,height=5.3>>=
genclustering("Day2.count_normalized.txt");
@
