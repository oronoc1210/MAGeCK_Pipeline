...
library(xtable)
filelist=c("PO1f_1_d6.fastq","PO1f_2_d6.fastq","PO1f_3_d6.fastq","PO1f_Cas9_ku70_1_d6.fastq","PO1f_Cas9_ku70_2_d6.fastq","PO1f_Cas9_ku70_3_d6.fastq");
labellist=c("PO1f_1","PO1f_2","PO1f_3","PO1f_Cas9_ku70_1","PO1f_Cas9_ku70_2","PO1f_Cas9_ku70_3");
reads=c(16616764,10471638,15579062,5295497,10861823,6085729);
mappedreads=c(13536990,7829815,9828003,2640590,5842561,3659466);
totalsgrnas=c(47591,47591,47591,47591,47591,47591);
zerocounts=c(1393,1408,1270,25875,24558,18689);
giniindex=c(0.14387847306110468,0.15227037108096098,0.14501232074142156,0.7178188641207774,0.6849842309687817,0.6259606056245548);
...
genboxplot("Day6_CS.count_normalized.txt");
@
...
genhistplot("Day6_CS.count_normalized.txt");
@
...
genpcaplot("Day6_CS.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.3,height=5.3>>=
genclustering("Day6_CS.count_normalized.txt");
@
